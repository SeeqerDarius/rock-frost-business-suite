...
- **School Management:** tenant-scoped tabbed student and guardian administration with one-step guardian admission, an explicit learner-profile action, a permission-aware 360-degree learner profile, validated and optimized passport photos, signed and revocable digital IDs with public QR verification and wallet-size PDF output, academic periods, tabbed classes and subjects, enrollment, bulk roster attendance, conduct, fees and Accounting integration, examinations, grading, timetables, transport, library, conditional Hostel integration, campus services, payroll integration, and accessible visual reporting.
