...
- **Accounting:** double-entry invoicing and expenses, explicit customer receipt allocations and statements, effective-dated tax codes, separate VAT/NHIL/GETFund evidence, Procurement input-tax integration, controlled tax periods and working VAT returns, classified cash, bank and mobile-money accounts, locked opening balances, a derived cashbook, reconciliation history, imprest petty cash, immutable posting numbers, serialized period controls, source-owned reversals, and financial reports. Fleet, Pharmacy, Hospital, POS, Installment, Hostel, Hotel, and School automatically post confirmed revenue into source-specific Revenue accounts; component-level tax capture for those revenue modules remains a controlled follow-on.
