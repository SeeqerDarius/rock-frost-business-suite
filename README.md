...
- **Fleet Management:** administrator-linked driver logins with assigned-vehicle-only dashboards, daily or weekly vehicle sales targets, duplicate-safe collection periods, atomic Work & Pay balance updates, private maintenance-photo reporting, ownership history, a linked Vehicle Owner portal role, and manager-verified payments and reporting. See `docs/FLEET_MODULE_IMPLEMENTATION.md`.
