...
- **Fleet Management:** administrator-linked driver logins with assigned-vehicle-only dashboards, daily or weekly vehicle remittance obligations, driver-recorded cash, mobile money and bank payments, daily or weekly Work & Pay instalments, duplicate-safe payment periods, atomic manager-verified balance updates, private maintenance-photo reporting, ownership history, a linked Vehicle Owner portal role, and reporting. See `docs/FLEET_MODULE_IMPLEMENTATION.md`.
