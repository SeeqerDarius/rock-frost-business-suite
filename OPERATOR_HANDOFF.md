...
- Release: committed to `agent/claude-offline-registry-foundation`. This branch was already pushed and verified in production for milestones through M11 (offline expansion); this UI-port commit needs its own push.
