...
export const PERMISSIONS = {
  ...
  ACCOUNTING_CONTACTS_MANAGE: "accounting.contacts.manage",
  ACCOUNTING_INVOICES_MANAGE: "accounting.invoices.manage",
  ACCOUNTING_RECEIVABLES_MANAGE: "accounting.receivables.manage",
  ACCOUNTING_BILLS_MANAGE: "accounting.bills.manage",
  ACCOUNTING_PAYABLES_MANAGE: "accounting.payables.manage",
  ...
  SCHOOL_STUDENT_FINANCE_VIEW: "school.student_finance.view",
  SCHOOL_ATTENDANCE_VIEW: "school.attendance.view",
  SCHOOL_CONDUCT_VIEW: "school.conduct.view",
  SCHOOL_CONDUCT_MANAGE: "school.conduct.manage",
  SCHOOL_DIGITAL_ID_MANAGE: "school.digital_id.manage",
  ...
  HOSPITAL_LAB_ENTER: "hospital.lab.enter",
  HOSPITAL_LAB_VERIFY: "hospital.lab.verify",
  HOSPITAL_IMAGING_ENTER: "hospital.imaging.enter",
  HOSPITAL_IMAGING_VERIFY: "hospital.imaging.verify",
...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  "Accounting Manager": moduleRolePermissions([
    ...
    PERMISSIONS.ACCOUNTING_CONTACTS_MANAGE,
    PERMISSIONS.ACCOUNTING_INVOICES_MANAGE,
    PERMISSIONS.ACCOUNTING_RECEIVABLES_MANAGE,
    PERMISSIONS.ACCOUNTING_BILLS_MANAGE,
    PERMISSIONS.ACCOUNTING_PAYABLES_MANAGE,
    ...
    PERMISSIONS.ACCOUNTING_PLANS_VIEW,
    PERMISSIONS.ACCOUNTING_PLANS_MANAGE,
    PERMISSIONS.ACCOUNTING_PLANS_APPROVE,
  ]),
  "HR Manager": moduleRolePermissions([
    ...
    PERMISSIONS.HR_TERMINATIONS_INITIATE,
    PERMISSIONS.HR_TERMINATIONS_APPROVE,
    PERMISSIONS.HR_EMPLOYEES_REINSTATE,
    PERMISSIONS.HR_SENSITIVE_DOCUMENTS_MANAGE,
    PERMISSIONS.HR_EMPLOYEES_EXPORT,
  ...
  "Procurement Manager": moduleRolePermissions([
    ...
    PERMISSIONS.PROCUREMENT_REQUESTS_APPROVE,
    PERMISSIONS.PROCUREMENT_ORDERS_MANAGE,
    PERMISSIONS.PROCUREMENT_RECEIPTS_MANAGE,
    PERMISSIONS.PROCUREMENT_INVOICES_MANAGE,
    PERMISSIONS.PROCUREMENT_INVOICES_APPROVE,
    PERMISSIONS.PROCUREMENT_PAYMENTS_MANAGE,
  ...
  "POS Cashier": moduleRolePermissions([
    ...
    PERMISSIONS.POS_RETURNS_MANAGE,
    PERMISSIONS.POS_VARIANCES_APPROVE,
  ...
  "School Administrator": moduleRolePermissions([
    ...
    PERMISSIONS.SCHOOL_PAYROLL_MANAGE, PERMISSIONS.SCHOOL_REPORTS_VIEW, PERMISSIONS.SCHOOL_SETTINGS_MANAGE, PERMISSIONS.SCHOOL_STAFF_MANAGE,
    PERMISSIONS.SCHOOL_STUDENT_PROFILE_VIEW, PERMISSIONS.SCHOOL_STUDENT_MEDICAL_VIEW, PERMISSIONS.SCHOOL_ACADEMIC_PERFORMANCE_VIEW,
  ...
  Warden: moduleRolePermissions([PERMISSIONS.HOSTEL_VIEW, PERMISSIONS.HOSTEL_ALLOCATIONS_MANAGE, PERMISSIONS.HOSTEL_REPORTS_VIEW]),
  "Pharmacy Manager": moduleRolePermissions([PERMISSIONS.PHARMACY_VIEW, PERMISSIONS.PHARMACY_MEDICINES_MANAGE, PERMISSIONS.PHARMACY_STOCK_MANAGE, PERMISSIONS.PHARMACY_PATIENTS_MANAGE, PERMISSIONS.PHARMACY_PRESCRIPTIONS_MANAGE, PERMISSIONS.PHARMACY_DISPENSING_MANAGE, PERMISSIONS.PHARMACY_RESTRICTED_VIEW, PERMISSIONS.PHARMACY_RESTRICTED_APPROVE, PERMISSIONS.PHARMACY_REPORTS_VIEW, PERMISSIONS.PHARMACY_SETTINGS_MANAGE]),
  Pharmacist: moduleRolePermissions([PERMISSIONS.PHARMACY_VIEW, PERMISSIONS.PHARMACY_MEDICINES_MANAGE, PERMISSIONS.PHARMACY_STOCK_MANAGE, PERMISSIONS.PHARMACY_PATIENTS_MANAGE, PERMISSIONS.PHARMACY_PRESCRIPTIONS_MANAGE, PERMISSIONS.PHARMACY_DISPENSING_MANAGE, PERMISSIONS.PHARMACY_RESTRICTED_VIEW, PERMISSIONS.PHARMACY_RESTRICTED_APPROVE, PERMISSIONS.PHARMACY_REPORTS_VIEW]),
  ...
  "Hospital Administrator": moduleRolePermissions([
    ...
    PERMISSIONS.HOSPITAL_LAB_ENTER, PERMISSIONS.HOSPITAL_LAB_VERIFY, PERMISSIONS.HOSPITAL_IMAGING_ENTER, PERMISSIONS.HOSPITAL_IMAGING_VERIFY,
    PERMISSIONS.HOSPITAL_MEDICATIONS_MANAGE,
  ...
  Doctor: moduleRolePermissions([
    ...
    PERMISSIONS.HOSPITAL_ADMISSIONS_MANAGE, PERMISSIONS.HOSPITAL_LAB_ENTER, PERMISSIONS.HOSPITAL_IMAGING_ENTER,
  ...
  "Laboratory Scientist": moduleRolePermissions([PERMISSIONS.HOSPITAL_VIEW, PERMISSIONS.HOSPITAL_LAB_ENTER, PERMISSIONS.HOSPITAL_LAB_VERIFY]),
  "Radiology Staff": moduleRolePermissions([PERMISSIONS.HOSPITAL_VIEW, PERMISSIONS.HOSPITAL_IMAGING_ENTER, PERMISSIONS.HOSPITAL_IMAGING_VERIFY]),
