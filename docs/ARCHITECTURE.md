...
- **RBAC is real and enforced**: 158 permission keys across sixteen internal module prefixes plus platform and organization capabilities, checked via `hasPermission()` and module access guards at both the page and Server Action layer. See `docs/AUTHENTICATION_AND_AUTHORIZATION.md`.
