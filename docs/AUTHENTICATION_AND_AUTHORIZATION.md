...
**Status: authentication (Phase 3), role/module-level authorization (Phase 4), and both Fleet's (Phase 6) and Installment's (Phase 7) action-level permissions are all real and enforced.**
