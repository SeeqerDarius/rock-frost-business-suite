...
**Phase 3 (manager Drivers roster redesign) and Phase 4 (trend visualizations wired into the new tabs) are still to come** - the "Access control" and "Financial behavior" sections below still describe the manager-facing Drivers page as it existed before this redesign.
