  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {summary.pendingRequestCount} pending request{summary.pendingRequestCount === 1 ? "" : "s"} · {summary.openOrderCount} open order{summary.openOrderCount === 1 ? "" : "s"} · {formatMoney(summary.openOrderValue, tenant.organization.currency)} outstanding
        </CardDescription>
      </CardHeader>
      {linkable ? (
        <CardContent>
