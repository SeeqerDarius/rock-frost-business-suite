...
import { LayoutGrid, BookOpen, FileText, Receipt, ScrollText, BarChart3, Landmark, Wallet, CalendarRange, Sparkles, UsersRound, BadgePercent, ChartNoAxesCombined, Contact, FileMinus2, FileSpreadsheet } from "lucide-react";
