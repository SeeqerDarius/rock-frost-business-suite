...
interface AnimatedSettingsIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

const AnimatedSettingsIcon = forwardRef<AnimatedSettingsIconHandle, AnimatedSettingsIconProps>(
    ...
    return (
      ...
      >
        <motion.svg
          ...
          strokeWidth="2"
          transition={{ type: "spring", stiffness: 38, damping: 12, mass: 1.15 }}
