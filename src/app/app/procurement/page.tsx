...
export default async function ProcurementOverviewPage() {
  ...
  const stats = [
    ...
    { label: "Open order value", value: formatMoney(summary.openOrderValue, tenant.organization.currency), description: "Committed value of open orders", icon: <Wallet className="size-4" />, href: "/app/procurement/orders" },
