  ...
  return <div className="space-y-6">
    ...
    <Tabs defaultValue={defaultTab}>
      ...
      <TabsContent value="reports" className="mt-4 space-y-6">
        ...
        <Card><CardHeader><CardTitle>Settlement statement</CardTitle><CardDescription>What can currently be calculated safely.</CardDescription></CardHeader><CardContent><div className="rounded-lg border bg-muted/30 p-4"><p className="font-medium">Settlement calculation not configured</p><p className="mt-1 text-sm text-muted-foreground">No approved owner agreement defines revenue share, management fees, expense responsibility or settlement frequency. Rock Frost will not estimate your entitlement.</p></div></CardContent></Card>
      </TabsContent>
    </Tabs>
  </div>;
}
