...
export default async function SchoolLayout({ children }: { children: React.ReactNode }) {
  ...
  return <AppShell sectionLabel="School Management" moduleKey="school" navigation={schoolNavigation} moduleSections={getFullModuleNavigation(tenant)} enabledModuleKeys={tenant.accessibleModuleKeys} organization={{ organizationId: tenant.organizationId, memberships: tenant.memberships }}>{children}</AppShell>;
}
