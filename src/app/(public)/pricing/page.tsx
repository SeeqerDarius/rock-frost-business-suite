...
export default async function PricingPage() {
  ...
  return <>
    <PublicHero centered eyebrow="Simple, modular pricing" title="Pay for the systems your organization actually uses." description="All prices are in Ghana cedis. Every subscription includes secure cloud hosting, updates, backups, role-based access, and the listed user seats. A 14-day trial can include up to three products." actions={<><Button nativeButton={false} render={<Link href="/subscribe" />}>Subscribe now</Button><Button variant="outline" nativeButton={false} render={<Link href="/contact?intent=demo" />}>Start a 14-day trial</Button></>} />
